...
export class BuyerMain extends Component {
    ...
    submitValidityCheck = () => {
        if(this.props.get('buyer_whereLogan') == 'Specify a place' || this.props.get('buyer_whenLogan') == 'Pick a time') {
            ...
            {/* ---------------------------------- Ordering page ---------------------------------- */}
            {
              ...
              <View regular style={styles.orderItem}>
                ...
                {this.props.get("order_exists") &&
                  <List
                    dataSource={this.ds.cloneWithRows(this.props.get("order_data"))}
                    renderRow={data =>
